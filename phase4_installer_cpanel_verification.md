...
- **Workflow**: `autoHealExistingSchema()` verifies table and column contracts for all 10 migrations:
  ...
  5. `2026_01_02_000000_expand_safa_and_wallet_tables` (`transactions` columns `customer_id`, `supplier_id`, `amount_sar`, `customer_rate`, `supplier_rate`, `amount_bdt`, `receiver_name`, `wallet_ledgers`, `wallet_batches`, `supplier_deposits`, `expenses_incomes`)
