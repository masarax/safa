...
@JsonClass(generateAdapter = true)
data class LoginResponse(@Json(name = "token") val token: String, @Json(name = "message") val message: String? = null)
@JsonClass(generateAdapter = true)
...
@JsonClass(generateAdapter = true)
data class GraphQlErrorLocation(@Json(name = "line") val line: Int? = null, @Json(name = "column") val column: Int? = null)
@JsonClass(generateAdapter = true)
data class GraphQlError(@Json(name = "message") val message: String = "", @Json(name = "locations") val locations: List<GraphQlErrorLocation>? = null, @Json(name = "path") val path: List<Any>? = null, @Json(name = "extensions") val extensions: Map<String, Any?>? = null)
@JsonClass(generateAdapter = true)
data class GraphQlResponse(@Json(name = "data") val data: Map<String, Any?>? = null, @Json(name = "errors") val errors: List<GraphQlError>? = null)
@JsonClass(generateAdapter = true)
