...
dependencies {
  ...
  // Migration-only compatibility reader for the pre-v3 EncryptedSharedPreferences
  // vault. New credentials use TokenVault + Android Keystore directly. Remove
  // this dependency after the documented installed-user migration horizon.
