...
dependencies {
  ...
  implementation("androidx.security:security-crypto:1.1.0-alpha06"); implementation(libs.androidx.work.runtime.ktx); implementation(libs.androidx.datastore.preferences); implementation(libs.coil.compose); implementation(libs.converter.moshi); implementation(libs.kotlinx.coroutines.android); implementation(libs.kotlinx.coroutines.core); implementation(libs.logging.interceptor); implementation(libs.moshi.kotlin); implementation(libs.okhttp); implementation(libs.retrofit)
