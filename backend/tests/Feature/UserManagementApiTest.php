...
class UserManagementApiTest extends TestCase
{
    ...
    {
        $staff = $this->createStaff();
        $this->withHeaders($this->getAuthHeaders($staff, 'GET', 'api/customers'))->get('/api/customers')->assertStatus(200);

        $staff->is_activated = false;
        $staff->save();
        $this->withHeaders($this->getAuthHeaders($staff, 'GET', 'api/customers'))->get('/api/customers')->assertStatus(401);
