    ...
    <div class="app-workspace">
        ...
        <main class="mobile-content app-content" id="mobile-content">
            ...
            <section class="screen" data-screen="customers">
                ...
                <div class="tool-row"><label class="search-box"><span class="icon icon-search" aria-hidden="true"></span><input id="customer-search" type="search" placeholder="{{ __('web.search_customer') }}"></label><select id="customer-filter" aria-label="{{ __('web.all_customers') }}"><option value="all">{{ __('web.all_customers') }}</option><option value="due">{{ __('web.due') }}</option><option value="advance">{{ __('web.advance') }}</option></select><select id="customer-sort" aria-label="{{ __('web.newest_first') }}"><option value="newest">{{ __('web.newest_first') }}</option><option value="oldest">{{ __('web.oldest_first') }}</option><option value="name">A–Z</option><option value="due">{{ __('web.by_due') }}</option></select></div>
            ...
            <section class="screen" data-screen="suppliers">
                ...
                <div class="tool-row"><label class="search-box"><span class="icon icon-search" aria-hidden="true"></span><input id="supplier-search" type="search" placeholder="{{ __('web.search_supplier') }}"></label><select id="supplier-filter" aria-label="{{ __('web.all_suppliers') }}"><option value="all">{{ __('web.all_suppliers') }}</option><option value="receivable">{{ __('web.receivable') }}</option><option value="payable">{{ __('web.payable') }}</option></select><select id="supplier-sort" aria-label="{{ __('web.newest_first') }}"><option value="newest">{{ __('web.newest_first') }}</option><option value="oldest">{{ __('web.oldest_first') }}</option><option value="name">A–Z</option><option value="balance">{{ __('web.balance') }}</option></select></div>
