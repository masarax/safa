    ...
    public function syncUp(Request $request)
    {
        try {
            ...
            $validator = Validator::make($request->all(), [
                ...
                'wallet_batches' => 'nullable|array|max:500', 'supplier_deposits' => 'nullable|array|max:500',
                'expenses_incomes' => 'nullable|array|max:500', 'wallet_ledgers' => 'nullable|array|max:500',
            ]);
            ...
            return response()->json(['status' => empty($conflicts) ? 'success' : 'conflict', 'server_time' => time(), 'accepted' => $accepted, 'rejected' => $rejected, 'conflicts' => $conflicts, 'permissions' => $permissions], 200);
        } catch (\Throwable $e) {
    ...
    public function syncDown(Request $request)
    {
        try {
            ...
            return response()->json([
                'status' => 'success', 'account_id' => $accountId, 'server_time' => time(),
                ...
                'permissions' => $permissions, 'user_permissions' => $permissions,
            ]);
        } catch (\Throwable $e) {
